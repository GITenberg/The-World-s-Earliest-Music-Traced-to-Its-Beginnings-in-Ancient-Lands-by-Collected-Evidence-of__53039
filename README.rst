...
This is a git repository of the source files for the book The World's Earliest Music
Traced to Its Beginnings in Ancient Lands by Collected Evidence of Relics, Records, History, and Musical Instruments from Greece, Etruria, Egypt, China, Through Asyria and Babylonia, to the Primitive Home, the Land of Akkad and Sumer by Hermann Smith. This book is in the Public Domain, see the LICENSE file for details.
...
Technical details
=================
The main source file for this book will be a file with a name containing `53039` with a file extension (ex. `.txt`, `.rst`, `.tei`, `.tex`). Some books also contain generated ebooks, html versions, and images/figures from the text as image files. Eventually, there will be generated ebooks in the downloads area.
